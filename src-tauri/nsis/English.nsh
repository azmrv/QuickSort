...
LangString appRunning ${LANG_ENGLISH} "QuickSort is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "QuickSort is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill QuickSort. Please close it first then try again"
