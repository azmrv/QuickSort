...
LangString appRunning ${LANG_RUSSIAN} "QuickSort запущен! Пожалуйста, закройте приложение и попробуйте еще раз."
LangString appRunningOkKill ${LANG_RUSSIAN} "QuickSort запущен!$\nНажмите OK чтобы закрыть приложение"
...
LangString failedToKillApp ${LANG_RUSSIAN} "Не удалось закрыть QuickSort. Пожалуйста, закройте приложение и попробуйте еще раз"
