...
pub use entities::{
    ...
    Locale, LogFormat, LogLevel, LoggingConfig, Operation, OperationSource, OperationState,
    OperationType, Plugin, PluginCapabilities, PluginConfig, PluginError, PluginInfo, PluginType,
    Settings, ThemeMode,
};
