...
pub use entities::{
    ...
    Locale, LogFormat, LogLevel, LoggingConfig, Operation, OperationState, OperationType, Plugin,
    PluginCapabilities, PluginConfig, PluginError, PluginInfo, PluginType, Settings, ThemeMode,
};
